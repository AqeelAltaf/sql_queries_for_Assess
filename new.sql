...
--else Uner_1M_End date. Make sure format of date will be MM/DD/YYYY
  ...
  TRY_CONVERT(date,CONCAT(assess.FISCAL_YEAR,'/',assess.FISCAL_MONTH,'/','1'))) is not null then FORMAT(EOMONTH(TRY_CONVERT(date,CONCAT(assess.FISCAL_YEAR,'/',assess.FISCAL_MONTH,'/','1'))),'MM/dd/yyyy') 
   -- -- if FISCAL MONTH is not given make Fiscal End date with these  values 
    when assess.FISCAL_MONTH = '' and assess.READY_TO_POST = 0  and assess.Assess_Year = '2016/17' and   LOWER(assess.BILL_CYCLE) like 'jan%' then  '12/31/2016' 
    when assess.FISCAL_MONTH = '' and assess.READY_TO_POST = 0  and assess.Assess_Year = '2016/17' and   LOWER(assess.BILL_CYCLE) like 'jul%' then  '06/30/2017' 
    when assess.FISCAL_MONTH = '' and assess.READY_TO_POST = 0  and assess.Assess_Year = '2017/18' and   LOWER(assess.BILL_CYCLE) like 'jan%' then  '12/31/2017' 
    when assess.FISCAL_MONTH = '' and assess.READY_TO_POST = 0  and assess.Assess_Year = '2017/18' and   LOWER(assess.BILL_CYCLE) like 'jul%' then  '06/30/2018' 
    else NULL end 
   as [Fiscal End Date],
 ...
 --else Uner_1M_Begin date. Make sure format of date will be MM/DD/YYYY "
  ...
  TRY_CONVERT(date,CONCAT(assess.FISCAL_MONTH,'/','1','/',assess.FISCAL_YEAR))) is not null then FORMAT(DATEADD(Month,-11,TRY_CONVERT(date,CONCAT(assess.FISCAL_MONTH,'/','1','/',assess.FISCAL_YEAR))),'MM/dd/yyyy') 
    ...
    when assess.FISCAL_MONTH = '' and assess.READY_TO_POST = 0  and assess.Assess_Year = '2016/17' and   LOWER(assess.BILL_CYCLE) like 'jan%' then  '01/01/2016' 
    when assess.FISCAL_MONTH = '' and assess.READY_TO_POST = 0  and assess.Assess_Year = '2016/17' and   LOWER(assess.BILL_CYCLE) like 'jul%' then  '07/01/2016' 
    when assess.FISCAL_MONTH = '' and assess.READY_TO_POST = 0  and assess.Assess_Year = '2017/18' and   LOWER(assess.BILL_CYCLE) like 'jan%' then  '01/01/2017' 
    when assess.FISCAL_MONTH = '' and assess.READY_TO_POST = 0  and assess.Assess_Year = '2017/18' and   LOWER(assess.BILL_CYCLE) like 'jul%' then  '07/01/2017' 
